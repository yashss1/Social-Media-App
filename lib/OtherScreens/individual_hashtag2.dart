...
class IndividualHashtag2 extends StatefulWidget {
  const IndividualHashtag2({Key? key, this.hashtag}) : super(key: key);

  final hashtag;

  @override
  _IndividualHashtag2State createState() => _IndividualHashtag2State();
}

class _IndividualHashtag2State extends State<IndividualHashtag2> {
  List postList = [];
